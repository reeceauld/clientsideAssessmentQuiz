...
let questions = [
    ...
    "Where did the Olypmic Games orginate?",
    "What year did World War 2 start?",
    "What is the oldest still spoken language?",
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("quizScoreCounterHis").value = (counterC);
                document.getElementById("answerFeedback").style.color = "rgb(24, 194, 24)"
                document.getElementById("feedbackh3").innerHTML = "Correct! The answer was " + answers2[3];
                setAnswers3();
            }
            else{
                counterW++;
                ...
                document.getElementById("quizScoreCounterHis").value = (counterC);
                document.getElementById("answerFeedback").style.color = "red"
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers2[3];
                setAnswers3();
            }
        }
    }
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("quizScoreCounterHis").value = (counterC);
                document.getElementById("answerFeedback").style.color = "rgb(24, 194, 24)"
                document.getElementById("feedbackh3").innerHTML = "Correct! The answer was " + answers3[3];
                setAnswers4();
            }
            else{
                counterW++;
                ...
                document.getElementById("quizScoreCounterHis").value = (counterC);
                document.getElementById("answerFeedback").style.color = "red"
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers3[3];
                setAnswers4();
            }
        }
    }
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("quizScoreCounterHis").value = (counterC);
                document.getElementById("answerFeedback").style.color = "rgb(24, 194, 24)"
                document.getElementById("feedbackh3").innerHTML = "Correct! The answer was " + answers4[2];
                setAnswers5();
            }
            else{
                counterW++;
                ...
                document.getElementById("quizScoreCounterHis").value = (counterC);
                document.getElementById("answerFeedback").style.color = "red"
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers4[2];
                setAnswers5();
            }
        }
    }
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("answerFeedback").style.color = "rgb(24, 194, 24)"
                document.getElementById("feedbackh3").innerHTML = "Correct! The answer was " + answers5[0];
                quizComplete();
            }
            else{
                counterW++;
                ...
                document.getElementById("answerFeedback").style.animationDuration = "2.5s";
                document.getElementById("answerFeedback").style.color = "red"
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers5[0];
                quizComplete();
            }
        }
    }
