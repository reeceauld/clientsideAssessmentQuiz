    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers[0];
                setAnswers2();
            }
        }
    }
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("quizScoreCounterMat").value = (counterC);
                document.getElementById("answerFeedback").style.color = "rgb(24, 194, 24)"
                document.getElementById("feedbackh3").innerHTML = "Correct! The answer was " + answers4[1];
                setAnswers5();
            }
            else{
                counterW++;
                ...
                document.getElementById("quizScoreCounterMat").value = (counterC);
                document.getElementById("answerFeedback").style.color = "red"
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers4[1];
                setAnswers5();
            }
        }
    }
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("answerFeedback").style.color = "rgb(24, 194, 24)"
                document.getElementById("feedbackh3").innerHTML = "Correct! The answer was " + answers5[3];
                quizComplete();
            }
            else{
                counterW++;
                ...
                document.getElementById("answerFeedback").style.animationDuration = "2.5s";
                document.getElementById("answerFeedback").style.color = "red"
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers5[3];
                quizComplete();
            }
        }
    }
