    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("feedbackh33").innerHTML = "Incorrect! The answer was " + answers3[2];
                setAnswers4();
            }
        }
    }
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("feedbackh34").innerHTML = "Incorrect! The answer was " + answers4[1];
                setAnswers5();
            }
        }
    }
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("feedbackh35").innerHTML = "Incorrect! The answer was " + answers5[3];
                quizComplete();
            }
        }
    }
