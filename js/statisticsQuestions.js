    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("quizScoreCounterSta").value = (counterC);
                document.getElementById("answerFeedback").style.color = "rgb(24, 194, 24)"
                document.getElementById("feedbackh3").innerHTML = "Correct! The answer was " + answers2[1];
                setAnswers3();
            }
            else{
                counterW++;
                ...
                document.getElementById("quizScoreCounterSta").value = (counterC);
                document.getElementById("answerFeedback").style.color = "red"
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers2[1];
                setAnswers3();
            }
        }
    }
    ...
    for(var i=0; i<questions.length; i++){
        ...
        if(checkboxes.length > 0){
            ...
            if(correctAnswers.every(answer => userAnswers.includes(answer))){
                ...
                document.getElementById("answerFeedback").style.color = "rgb(24, 194, 24)"
                document.getElementById("feedbackh3").innerHTML = "Correct! The answer was " + answers5[2];
                quizComplete();
            }
            else{
                counterW++;
                ...
                document.getElementById("answerFeedback").style.animationDuration = "2.5s";
                document.getElementById("answerFeedback").style.color = "red"
                document.getElementById("feedbackh3").innerHTML = "Incorrect! The answer was " + answers5[2];
                quizComplete();
            }
        }
    }
